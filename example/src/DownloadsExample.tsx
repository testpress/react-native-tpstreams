  ...
  useEffect(() => {
    ...
    const setupEventListeners = async () => {
      try {
        ...
        eventEmitter = new NativeEventEmitter(TPStreamsDownloads);
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.header}>
        Downloads using TPStreamsDownloads TurboModule ({downloads.length})
      </Text>
...
export default DownloadsExample;
